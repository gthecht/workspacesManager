...
class TestFilesGatherer:
    def test_get_open_files_with_no_paths(
        self,
        test_path,
        start_time,
        get_files_gatherer,
    ...
    def test_get_open_files_call_powershell(
        self,
        test_path,
        start_time,
        get_files_gatherer,
    ...
    def test_get_files_from_powershell_multiple_paths(
        self,
        test_path,
        start_time,
        get_files_gatherer,
    ...
    def test_get_files_from_powershell(
        self,
        test_path,
        file_path,
        start_time,
